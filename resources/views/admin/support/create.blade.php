    ...
    <div class="bg-white rounded-lg p-6 shadow-sm border border-sand-200/60 flex flex-col gap-3">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-2 text-xs text-on-surface-variant">
                ...
                <span>/</span>
                <a href="{{ route('admin.support.show', $department) }}" class="hover:text-gold-500">{{ strtoupper($department) }}</a>
                <span>/</span>
                <span class="font-medium text-on-surface">Form Inisiasi SOP Support</span>
            </div>
        </div>

        <!-- Baris Judul -->
        <div>
            <h2 class="text-xl font-extrabold text-on-surface uppercase tracking-tight">Form Inisiasi SOP Support</h2>
            <p class="text-xs text-on-surface-variant mt-0.5">Unggah berkas komponen SOP untuk departemen {{ strtoupper($department) }}</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-12 bg-white rounded-lg p-6 shadow-sm border border-sand-200/60 space-y-5">
                <div class="flex items-center space-x-3 border-b border-sand-200/40 pb-3">
                    ...
                    <div>
                        <h4 class="font-extrabold text-xs uppercase tracking-wider text-on-surface">Informasi SOP Support</h4>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div id="support-additional-approvers" class="hidden fixed inset-0 z-50 bg-charcoal-900/60 backdrop-blur-sm items-center justify-center p-4">
                            ...
                            <div class="flex items-start justify-between gap-4 border-b border-sand-200/60 pb-3 mb-4"><div><p class="text-[10px] font-extrabold uppercase tracking-wider text-gold-500">Pilih tambahan</p><h4 class="text-sm font-extrabold text-on-surface mt-1">Pilih tambahan pengesah</h4></div><button type="button" onclick="closeAdditionalApprovers('support-additional-approvers')" class="w-8 h-8 rounded-md bg-canvas border border-sand-200 text-on-surface-variant flex items-center justify-center"><span class="material-symbols-outlined text-lg">close</span></button></div>
                            ...
                            @foreach($reviewers as $user)
                                ...
                                @endif
                            @endforeach
                            </div><div class="flex justify-end mt-5"><button type="button" onclick="closeAdditionalApprovers('support-additional-approvers')" class="px-4 py-2 bg-charcoal-900 text-gold-fixed rounded-md text-[10px] font-extrabold uppercase tracking-wider">Simpan Pilihan</button></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-12 bg-white rounded-lg p-6 shadow-sm border border-sand-200/60 space-y-6">
                <div class="flex items-center space-x-2 border-b border-sand-200/40 pb-3">
                    ...
                    <h4 class="font-extrabold text-xs uppercase tracking-wider text-on-surface">Upload Berkas PDF Komponen SOP Support</h4>
                </div>
