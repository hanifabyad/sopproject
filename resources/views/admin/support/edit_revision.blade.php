...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <a href="{{ route('admin.support.document.detail', $document->id) }}" class="px-3.5 py-1.5 bg-white border border-[#cfc6ac] text-[#333028] hover:bg-[#fff9ed] rounded-md font-bold text-xs transition-all shadow-sm flex items-center gap-1.5">
    ...
    <div class="bg-white rounded-lg p-6 md:p-8 shadow-sm border border-[#cfc6ac]/60 space-y-6">
        <div class="border-b border-[#cfc6ac]/40 pb-4">
            ...
            <h2 class="text-xl font-extrabold text-[#1e1c14] uppercase tracking-tight mt-2">Unggah Perbaikan Dokumen SOP Support</h2>
        ...
        <form action="{{ route('admin.support.update_revision', $document->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
