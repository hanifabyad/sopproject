    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white rounded-lg p-6 border border-[#cfc6ac]/60 shadow-sm">
        <div>
            <div class="flex items-center space-x-2 mb-1">
                <span class="px-2.5 py-0.5 bg-[#ffd92f]/20 text-[#705d00] font-extrabold text-[10px] uppercase rounded tracking-wider border border-[#ffd92f]/40">Unit Bisnis</span>
            </div>
            <h2 class="text-xl font-extrabold text-[#1e1c14] uppercase tracking-tight">Divisi Business Unit</h2>
            <p class="text-xs text-[#4d4633] mt-0.5">Monitoring dokumen operasional seluruh divisi unit bisnis PT PKM Group</p>
        </div>
    </div>
                    ...
                    <tr class="border-b border-[#e8e2d6] hover:bg-[#f7f6f2] transition-colors">
                        ...
                        <td class="py-3.5 px-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <span class="font-semibold text-[#1e1c14] text-[14px] uppercase block leading-tight">{{ $namaDivisi }}</span>
                                    <span class="text-[10px] text-[#4d4633] font-normal uppercase">Divisi Utama</span>
                                </div>
                            </div>
                        </td>
                        <td class="py-3.5 px-4">
                            <span class="text-xs font-semibold text-[#4d4633] uppercase bg-[#f7f6f2] px-2.5 py-1 rounded-md border border-[#cfc6ac]/40">
                        ...
                        <td class="py-3.5 px-4 text-right">
                            <a href="{{ route('admin.BU.divisi.show', $namaDivisi) }}" class="px-4 py-1.5 rounded-md bg-[#705d00] text-white hover:bg-[#544600] text-xs font-medium inline-flex items-center gap-1.5 transition-colors">
