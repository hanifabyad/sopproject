    ...
    <div class="bg-white rounded-lg p-6 shadow-sm border border-[#cfc6ac]/60 flex flex-col gap-3">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-2 text-xs text-[#4d4633]">
                ...
                <span>/</span>
                <a href="{{ route('admin.BU.show', $unit) }}" class="hover:text-[#705d00]">{{ $unit }}</a>
                <span>/</span>
                <span class="font-medium text-[#1e1c14]">Form Inisiasi SOP Baru</span>
            </div>
        </div>

        <!-- Baris Judul -->
        <div>
            <h2 class="text-xl font-extrabold text-[#1e1c14] uppercase tracking-tight">Form Inisiasi SOP Baru</h2>
            <p class="text-xs text-[#4d4633] mt-0.5">Unggah berkas komponen SOP untuk unit operasional {{ $unit }}</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-7 bg-white rounded-lg p-6 shadow-sm border border-[#cfc6ac]/60 space-y-5">
                <div class="flex items-center space-x-3 border-b border-[#cfc6ac]/40 pb-3">
                    ...
                    <div>
                        <h4 class="font-extrabold text-xs uppercase tracking-wider text-[#1e1c14]">Informasi SOP & Parameter Signer</h4>
                        <p class="text-[11px] text-[#4d4633]">Isi metadata dokumen dan tentukan pejabat penandatangan</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="title" required value="{{ old('title') }}" placeholder="Contoh: Prosedur Operasional Standar Penerimaan BBM"
                    ...
                    <div>
                        ...
                        <input type="text" name="doc_number" required placeholder="Contoh: PM-SCK-MKT-01" class="w-full p-2.5 bg-[#fbf9f4] border border-[#cfc6ac] rounded-md text-xs font-semibold text-[#1e1c14] focus:bg-white focus:ring-2 focus:ring-[#705d00] outline-none">
                    </div>
            ...
            <div class="lg:col-span-5 bg-[#e3dbc9]/40 rounded-lg p-6 shadow-sm border border-[#cfc6ac] flex flex-col justify-between space-y-6">
                ...
                <div class="p-3.5 bg-white/80 rounded-md border border-white/80 space-y-1.5">
                    ...
                    <p class="text-[10px] text-[#4d4633] leading-relaxed">
                        Lembar Pengesahan (LP) 2 halaman standar ISO e-QMS akan digenerate secara otomatis beserta qr-code dan stempel digital penandatangan.
                    </p>
                </div>
            </div>
            ...
            <div class="lg:col-span-12 bg-white rounded-lg p-6 shadow-sm border border-[#cfc6ac]/60 space-y-6">
                <div class="flex items-center space-x-2 border-b border-[#cfc6ac]/40 pb-3">
                    ...
                    <h4 class="font-extrabold text-xs uppercase tracking-wider text-[#1e1c14]">Upload Berkas PDF Komponen SOP</h4>
                </div>
