...
@section('title', 'Unggah SOP Unit Bisnis - e-QMS')
...
<style>
    ...
    /* Styling scrollbar untuk daftar reviewer agar tetap rapi */
    .custom-scrollbar::-webkit-scrollbar { width: 4px; }
    .custom-scrollbar::-webkit-scrollbar-track { background: #f8fafc; border-radius: 10px; }
    .custom-scrollbar::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 10px; }
    
    /* Animasi untuk badge nomor urut pimpinan */
    .sequence-number {
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
            <h2 class="text-2xl font-black text-[#1e293b] uppercase tracking-tight flex items-center gap-2">
                <i class="fa-solid fa-cloud-arrow-up text-blue-600"></i> UNGGAH DOKUMEN SOP
            </h2>
        ...
        <a href="{{ route('admin.BU.show', $unit) }}" class="bg-white border border-gray-200 text-gray-700 px-5 py-2.5 rounded-xl font-bold text-[10px] uppercase tracking-wider hover:bg-gray-50 transition-all duration-300 shadow-sm flex items-center gap-2 transform hover:-translate-y-0.5">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-100">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="title" required value="{{ old('title') }}" placeholder="Contoh: Prosedur Pengelolaan Gudang"
                        ...
                        <div>
                            <label class="block text-[9px] font-bold uppercase text-gray-400 tracking-wider mb-1.5 ml-1">Unit Bisnis Terkait (BU)</label>
                            <div class="relative">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            // Evaluasi validasi urutan klik agar admin tidak lupa memilih pimpinan
