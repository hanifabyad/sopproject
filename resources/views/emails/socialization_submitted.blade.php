...
<head>
    ...
    <title>Bukti Sosialisasi SOP Masuk - e-QMS</title>
...
<body style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; background-color: #F4F5F6; margin: 0; padding: 30px 15px; color: #1A1A1A;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border: 1px solid #E5E7EB; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.05);">
        ...
        <!-- COLOR ACCENT BAR (TEAL / BLUE) -->
        <tr>
            <td height="4" bgcolor="#00b4d8"></td>
        </tr>
        ...
        <tr>
            <td style="padding: 36px 28px;">
                ...
                <div style="margin-bottom: 16px;">
                    <span style="display: inline-block; padding: 4px 12px; background-color: #ECFEFF; border: 1px solid #A5F3FC; border-radius: 20px; font-size: 11px; font-weight: 700; color: #0891B2; text-transform: capitalize; letter-spacing: 0.5px;">
                        LAPORAN BUKTI SOSIALISASI SOP
                    </span>
                </div>
                ...
                <p style="font-size: 13px; line-height: 1.6; color: #4B5563; margin: 0 0 20px 0;">
                    PIC Departemen terkait telah mengunggah <strong>bukti pelaksanaan sosialisasi</strong> (berkas daftar hadir dan foto-foto dokumentasi kegiatan) untuk dokumen SOP berikut:
                </p>
                ...
                <table width="100%" cellpadding="12" cellspacing="0" style="border-collapse: collapse; border: 1px solid #E5E7EB; border-radius: 8px; margin-bottom: 20px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="font-size: 12px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #F3F4F6;">Tanggal Pelaksanaan</td>
                        <td style="font-size: 12px; color: #1A1A1A; border-bottom: 1px solid #F3F4F6; font-weight: 600;">{{ $socialization->socialization_date ? $socialization->socialization_date->format('d F Y') : '-' }}</td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #F3F4F6;">Diunggah Oleh</td>
                        <td style="font-size: 12px; color: #1677B8; border-bottom: 1px solid #F3F4F6; font-weight: 600;">{{ $submitter->full_name ?? ($submitter->username ?? 'PIC Terkait') }}</td>
                    </tr>
                    @if(!empty($socialization->notes))
                    <tr>
                        <td style="font-size: 12px; font-weight: 600; color: #6B7280;">Catatan Kegiatan</td>
                        <td style="font-size: 12px; color: #374151; font-weight: 500;">{{ $socialization->notes }}</td>
                    </tr>
                    @endif
                </table>

                <p style="font-size: 13px; line-height: 1.6; color: #4B5563; margin: 0 0 24px 0;">
                    Silakan buka menu <strong>Verifikasi Aktivitas</strong> pada dashboard admin e-QMS untuk memverifikasi dokumen daftar hadir serta galeri foto dokumentasi.
                </p>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" bgcolor="#1677B8" style="border-radius: 6px; box-shadow: 0 4px 6px -1px rgba(22, 119, 184, 0.25);">
                            <a href="{{ $actionUrl ?? route('admin.user_reviews.index', ['tab' => 'socialization']) }}" target="_blank" style="display: inline-block; padding: 14px 32px; font-size: 12px; font-weight: 700; color: #ffffff; text-decoration: none; text-transform: capitalize; letter-spacing: 0.5px;">
                                VERIFIKASI BUKTI SOSIALISASI &rarr;
                            </a>
                        </td>
                    </tr>
                </table>
