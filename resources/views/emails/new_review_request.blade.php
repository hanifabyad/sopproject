        ...
        <tr>
            <td style="padding: 40px 30px;">
                ...
                <p style="font-size: 13px; line-height: 1.6; color: #4B5563; margin-bottom: 25px;">
                    Terdapat dokumen SOP baru yang membutuhkan peninjauan, verifikasi, dan tanda tangan digital Anda pada alur persetujuan sistem <strong>e-QMS</strong>.
                </p>
                ...
                <table width="100%" cellpadding="12" cellspacing="0" style="border-collapse: collapse; border: 1px solid #E5E7EB; border-radius: 8px; margin-bottom: 30px; overflow: hidden;">
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; color: #D97706; font-weight: 700; text-transform: uppercase;">{{ $document->status }} (Waiting Review)</td>
                    </tr>
                </table>
 
                <p style="font-size: 13px; line-height: 1.6; color: #4B5563; margin-bottom: 30px;">
                    Silakan gunakan tombol di bawah untuk masuk ke dashboard secara otomatis menggunakan Magic Link Anda yang aktif selama 24 jam.
                </p>
