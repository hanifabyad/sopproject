        ...
        <tr>
            <td style="padding: 36px 28px;">
                ...
                <div style="margin-bottom: 16px;">
                    <span style="display: inline-block; padding: 4px 12px; background-color: #EFF6FF; border: 1px solid #BFDBFE; border-radius: 20px; font-size: 11px; font-weight: 700; color: #1677B8; text-transform: uppercase; letter-spacing: 0.5px;">
