...
<body style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p>Selamat! Dokumen yang Anda buat telah disetujui oleh Final Approver dan kini berstatus <strong>Active</strong> di sistem e-QMS.</p>
    ...
    <p>Dokumen Anda telah masuk ke dalam E-Library dan dapat diakses oleh pihak yang berkepentingan.</p>
    <p style="margin-top: 25px;">
        <a href="{{ $magicLoginUrl }}" class="button">Lihat Dokumen</a>
    </p>
