        ...
        <tr>
            <td style="padding: 40px 30px;">
                ...
                <table width="100%" cellpadding="12" cellspacing="0" style="border-collapse: collapse; border: 1px solid #E5E7EB; border-radius: 8px; margin-bottom: 30px; overflow: hidden;">
                    <tr bgcolor="#F9FAFB">
                        <td colspan="2" style="font-size: 11px; font-weight: 700; text-transform: uppercase; tracking-wider; color: #DC2626; border-bottom: 1px solid #E5E7EB;">
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; color: #1a1a1a; border-bottom: 1px solid #F3F4F6; font-weight: 500;">{{ $requester->full_name ?? $requester->username }} ({{ $requester->role }})</td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #F3F4F6;">Catatan Revisi</td>
                        <td style="font-size: 12px; color: #DC2626; font-weight: 600; border-bottom: 1px solid #F3F4F6; line-height: 1.5;">{{ $notes }}</td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px; font-weight: 600; color: #6B7280;">Status Dokumen</td>
                        <td style="font-size: 12px; color: #DC2626; font-weight: 700; text-transform: uppercase;">{{ $document->status }} (Need Revision)</td>
                    </tr>
                </table>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" bgcolor="#DC2626" style="border-radius: 6px; box-shadow: 0 4px 6px -1px rgba(220, 38, 38, 0.2);">
